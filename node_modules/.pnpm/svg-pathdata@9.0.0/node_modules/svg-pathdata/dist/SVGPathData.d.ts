import { TransformableSVG } from 'svg-pathdata/dist/TransformableSVG.js';
import type { SVGCommand } from 'svg-pathdata/dist/types.js';
export declare class SVGPathData extends TransformableSVG {
    commands: SVGCommand[];
    constructor(content: string | SVGCommand[]);
    encode(): string;
    getBounds(): import("svg-pathdata/dist/types.js").TransformFunction & {
        minX: number;
        maxX: number;
        minY: number;
        maxY: number;
